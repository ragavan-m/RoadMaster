...
$requirements = isset($_POST["requirements"]) ? $_POST["requirements"] : "";
    ...
    $sql = "INSERT INTO rides (user_id, name, phone, email, pickup_location, destination, pickup_date, pickup_time, requirements) VALUES ('$user_id', '$name', '$phone', '$email', '$pickup', '$destination', '$date', '$time','$requirements')";
